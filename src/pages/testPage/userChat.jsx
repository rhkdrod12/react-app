...
import { DEFAULT_URL, getFetch, makeGetParam } from "../../hook/useFetch.jsx";
      ...
      {chatId ? (
        ...
        <div style={{ display: "flex", justifyContent: "flex-end" }}>
          ...
          <Button
            onClick={onCreate}
            variant="contained"
            sx={{ alignItems: "center", height: "30px", marginLeft: "4px" }}
          >
            <span>방생성</span>
          </Button>
        </div>
...
const useChatEvent = (chatId, name) => {
  ...
  useEffect(() => {
    if (chatId) {
      // URL 생성
      const url = makeGetParam(`${DEFAULT_URL}/chat/beginChat/${chatId}`, {
        name,
      });
      // 이벤트 생성
